...
import { createProduct, getAllProducts, getProduct, getSellProducts, editProduct, getUserProduct } from '../controllers/products.js'
...
router.get('/all', jwt, getAllProducts) // 取所有商品，管理員用
router.get('/user', jwt, getUserProduct) // 取使用者
